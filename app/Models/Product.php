...
class Product extends Model
{
    ...
    public static function transfer_product($user_id_from, $user_id_to, $product_id, $status_id_to, $note = null)
    {
        ...
        if ($status_id_to == 3) {
            /** Đại lý bán hàng cho người dùng hoặc trả lại sản phẩm đã bảo hành*/
            $message = 'nothing';
            if (!$note) {
            ...
            /**Đại lý nhận sp cần bảo hành từ người dùng */
            ...
            /**Đại lý nhận sản phẩm sửa xong từ trung tâm bảo hành */
            ...
            /**TTBh chuyển sp ko sửa được đến cơ sở sản xuất */
