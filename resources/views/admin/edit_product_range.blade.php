...
@section('content')
  <form method="POST" action='{{ route('admin.put_edit_product_range', ['id' => $range_edit->id]) }}'>
    @csrf
    <div class="form-group">
      <label for="name">Tên dòng sản phẩm</label>
      <input type="text" class="form-control" id="name" name="name" value="{{ $range_edit->name }}">
      @error('name')
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="property" name="property" value="{{ $range_edit->property }}">
      @error('property')
        <span style="color:red">{{ $message }}</span>
      @enderror
    </div>
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="warranty_period_time" name="warranty_period_time" value="{{ $range_edit->warranty_period_time }}">
